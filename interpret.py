#%%
""" Fits a linear regression model to the contexts and the underlying paramters """

import torch
import numpy as np
from sklearn.linear_model import LinearRegression

train_folder = 'results/lotka/20240326_110005-Special/'
test_folder = 'results/lotka/20240328_022415/'



#%%
X_train = torch.stack(torch.load(train_folder+'model_train.pt')['codes'], axis=0).detach().cpu().numpy()
X_train
...
#%%
X_test = torch.load(test_folder+'codes.pt').detach().cpu().numpy()
...
#%% 
""" Plot Y_test vs Y_pred, same for training, all this on the same plot """
